...
public class Ejercicio15 {
  public static void main(String[] args) {
    ...
    verdadero = V.equalsIgnoreCase("Verdadero")?true : false;
    if (verdadero == true) {
      contadorVerdadero +=3;
      }
    ...
    System.out.print("7. Muchos días viene tarde después de trabajar porque dice tener mucho más trabajo");
    V = teclado.next();
    verdadero = V.equalsIgnoreCase("Verdadero")?true : false;
    if (verdadero == true) {
      contadorVerdadero +=3;
    ...
    System.out.print("8. Has notado que últimamente se perfuma más");
    V = teclado.next();
    verdadero = V.equalsIgnoreCase("Verdadero")?true : false;
    if (verdadero == true) {
      contadorVerdadero +=3;
    ...
    System.out.print("9. Se confunde y te dice que ha estado en sitios donde no ha ido contigo");
    V = teclado.next();
    verdadero = V.equalsIgnoreCase("Verdadero")?true : false;
    if (verdadero == true) {
      contadorVerdadero +=3;
    ...
    if ((contadorVerdadero > 0) && (contadorVerdadero <=10)){
      System.out.println("¡Enhorabuena! tu pareja parece ser totalmente fiel");
    }else if ((contadorVerdadero >= 11) && (contadorVerdadero < 22)){
      System.out.println("Quizás exista el peligro de otra persona en su vida o en su mente, aunque seguramente será algo sin importancia. No bajes la guardia.");
    }else if ((contadorVerdadero > 22) && (contadorVerdadero <= 30)){
