package U8.T1.ejercicioRepaso.STAX.Ej1.ImprimirSTAX.EJ1;
...
public class mostrarSTAX {
    public static void main(String[] args) {
        ...
        try {
            ...
            XMLEventReader xmlReaderEvent = xmlInputFactory.createXMLEventReader(new FileInputStream("src/main/java/U8/T1/ejercicioRepaso/STAX/Ej1/tiendas.xml"));
